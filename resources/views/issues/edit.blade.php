                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="priority_id">
                                @foreach ($priorities as $priority)
                                    <option value="{{ $priority->id }}" {{ optional($issue->priority)->id == $priority->id ? 'selected' : '' }}>{{ $priority->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="type_id">
                                @foreach ($types as $type)
                                    <option value="{{ $type->id }}" {{ optional($issue->type)->id == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                                @endforeach
                            </select>
                        </div>
